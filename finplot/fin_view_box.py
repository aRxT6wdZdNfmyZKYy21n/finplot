...
class FinViewBox(pg.ViewBox):
        ...
        if not self.drawing:
            ...
            self.draw_line = (
                FinPolyLine(
                    ...
                    pen=(
                        pg.mkPen(
                            FinPlotConstants.draw_line_color,
                            movable=False
                        )
                    )
                )
    ...
    def pan_x(self, steps=None, percent=None):
        ...
        tr = self.targetRect()
        x1 = tr.right() + steps
        startx = -FinPlotConstants.side_margin
    ...
    def update_y_zoom(self, x0=None, x1=None):
        ...
        x0 = (
            max(
                (
                    _round(
                        x0 - FinPlotConstants.side_margin
                    ) +
